    ...
    return (
        <div className={styles.container}>
			...
			<img src="qylislogo.png" alt="Logo" className="logo" />
                <h2 className={styles.heading}>Login to Qylis Labs</h2>
                <form onSubmit={handleSubmit}>
                    ...
                    <div className={styles.inputGroup}>
                        ...
                        <input
                            ...
                            required
                        />
                        <span className={styles.email} onClick={handleTogglePassword}>
                ...
                <label>Login/Register with</label>
                ...
                <div className={styles.iconsContainer}>
					...
					<div className={styles.image}>
                        <img className={styles.google} src="qylislogo.png" />
                    </div>
                </div>
            </div>
        </div>
